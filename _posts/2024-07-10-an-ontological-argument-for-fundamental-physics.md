...
Here, religion is defined as a dogmatic belief about the afterlife, which includes Buddhism & Jainism. Note that I have exaggerated things in the above diagram for the sake of visibility; otherwise, atheism should be infinitely smaller than theism (as theism contains all theories with 1 god+ all with 2 gods + so on), and naturalism should be infinitely smaller than atheism, and String theory landscape should be infinitely smaller than Swampland (physics) etc. There isn't any difference between the chance of Christianity/Hinduism being correct and the chance of Dragon Ball being correct (correct meaning all of that actually happened in real life, but the footage was lost, & believing the manga/anime as retelling by those who saw it), as all are exactly 0%.
